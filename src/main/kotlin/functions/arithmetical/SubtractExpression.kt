...
class SubtractExpression(arg1: IntExpression, arg2: IntExpression): ArithmeticalExpression(arg1, arg2) {
    ...
    override fun simplify(): Expression<Int> {
        ...
        if (arg2 is NumExpression && (arg2 as NumExpression).num < 0) {
            exp = SumExpression(arg1, NumExpression(-(arg2 as NumExpression).num))
        }
        return exp
    }
    override fun toAlgExp(): xyz.avarel.aljava.Expression {
        return arg1.toAlgExp().minus(arg2.toAlgExp())
    }
